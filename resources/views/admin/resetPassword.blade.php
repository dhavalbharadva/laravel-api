                                ...
                                <div class="row m-0">
                                    ...
                                    <div class="col-lg-6 col-12 p-0">
                                        <div class="card rounded-0 mb-0 px-2">
                                            ...
                                            <p class="px-2">Now you just need to provide registered email and set new password for further use.</p>
                                            <div class="card-content">
                                                <div class="card-body pt-1">
                                                    {{-- Notifications --}}
                                                    @include('admin.includes.notifications')
                                                    
                                                    {!! Form::open(array('route' => array(ADMIN_SLUG.'.password.reset', $token),'id' => 'reset-password-form')) !!}
                                                    {!! Form::hidden('token', $token) !!}
                                                        ...
                                                        <div class="form-group d-flex align-items-center">
                                                            <div class="text-left mr-2">
                                                                <button type="submit" class="btn btn-primary float-right btn-inline">Save</button>
                                                            </div>
                                                            <div class="text-right">
                                                                <a href="{!!URL(ADMIN_SLUG)!!}" class="btn btn-outline-warning">Cancel</a>
                                                            </div>
                                                        </div>
                                                    {!! Form::close() !!}
                                                </div>
